...
def main(argv=sys.argv):
    ...
    with transaction.manager:
        startup = Startup(name='Startup5000',
                          ...
                          logo_url='startups/1.jpg',
                          thumb_url='startups/1_thumb.jpg',
        ...
        article1 = Article(startupdex_id=1,
                           ...
                           thumb_url="articles/1_1_thumb.jpg",
                           )
        article2 = Article(startupdex_id=1,
                           ...
                           thumb_url="articles/1_2_thumb.jpg",
                           )
        article3 = Article(startupdex_id=1,
                           ...
                           thumb_url="articles/1_3_thumb.jpg",
                           )
        article4 = Article(startupdex_id=1,
                           ...
                           thumb_url="articles/1_4_thumb.jpg",
                           )
        article5 = Article(startupdex_id=1,
                           ...
                           thumb_url="articles/1_5_thumb.jpg",
                           )
        article6 = Article(startupdex_id=1,
                           ...
                           thumb_url="articles/1_6_thumb.jpg",
                           )
        article7 = Article(startupdex_id=1,
                           ...
                           thumb_url="articles/1_7_thumb.jpg",
                           )
        article8 = Article(startupdex_id=1,
                           ...
                           thumb_url="articles/1_8_thumb.jpg",
                           )
